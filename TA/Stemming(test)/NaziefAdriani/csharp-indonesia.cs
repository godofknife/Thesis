...
namespace WindowsFormsApplication12
{
    ...
    {
        string[] kamus;
        string connectionSQL = @"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=stemmingindo.accdb; Persist Security Info=False;";
        public string sql;
        ...
        {
            int jumlah = 0;
            OleDbConnection db = new OleDbConnection(connectionSQL);
            db.Open();
            OleDbCommand cmd = db.CreateCommand();
            string sql = sQuery;
            cmd.CommandText = sql;
            jumlah = (Int32)cmd.ExecuteScalar();
            db.Close();
            return jumlah;
        }
